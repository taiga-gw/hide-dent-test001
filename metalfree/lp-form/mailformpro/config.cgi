...
push @mailto,'j.mori@gurukun-web.com';
...
## 設置者に届くメールの件名
$config{'subject'} = 'メタルフリー治療お問い合わせのお知らせ';

## 設置者に届くメールの本文整形
$_TEXT{'posted'} = <<'__posted_body__';

WEBより「メタルフリー治療」のお問い合わせがあります。
内容を確認の上、ご連絡お願いします。
──────────────────────────
[氏名] <_氏名_>
[ふりがな] <_ふりがな_>
...
$config{"ReturnSubject"} = 'メタルフリー治療お問い合わせ控え[ひで歯科クリニック]';
...
<_氏名_> 様
──────────────────────────
メタルフリー治療についてお問い合わせいただき、誠にありがとうございます。
